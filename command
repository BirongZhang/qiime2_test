...
# Importing the multiplexed sequence data
qiime tools import \
...
### plot a boxplot and identify taxa that could be explaining the differences between the control and patient groups.
